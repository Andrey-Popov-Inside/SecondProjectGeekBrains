...
public class MainClass {
    public static void main(String[] args) {
        ...
        String[][] error_data = {{"1","1error","3","4",},{"1","2","3","4"}};


        System.out.println("1) Случай корректного массива");
        try {
            result = 0;
        ...
        System.out.println("2) Случай некорректного массива");
        try {
            result = 0;
        ...
        System.out.println("3) Случай некорректных данных");
        try {
            result = 0;
