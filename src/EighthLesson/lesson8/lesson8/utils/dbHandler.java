package EighthLesson.lesson8.lesson8.utils;
...
public class dbHandler {
    ...
    public List<SevenLesson.lesson7.utils.Weather> getAllWeather(){
        List<SevenLesson.lesson7.utils.Weather> weathers = new ArrayList<>();
